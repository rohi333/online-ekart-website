...
class Cart
{
    ...
    public function addToCart($quantity,$id){
		...
		$query = "INSERT INTO tbl_cart(sId,productId,productName,price,quantity,image,cmrId) VALUES('$sId','$productId','$productName','$price','$quantity','$image','$cmrId')";
  ...
  public function getCartProduct(){
   $sId = session_id();
   $cmrId=Session::get('cmrId');
   $query = "SELECT * FROM tbl_cart WHERE sId = '$sId' AND cmrId='$cmrId'";
